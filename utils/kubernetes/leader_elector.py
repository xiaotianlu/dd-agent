...
CM_NAME = 'datadog_leader_elector'
...
class LeaderElector:
    ...
    def _get_cm(self):
        ...
        try:
            ...
            res = self.kubeutil.retrieve_json_auth(cm_url).get('items')
        except Exception as ex:
    ...
    def _try_lock_cm(self, cm):
        ...
        cm_url = urljoin(self.apiserver_url, CM_ENDPOINT.format(namespace=DEFAULT_NAMESPACE))
        if cm:
            try:
        ...
        pl = {
            ...
            'metadata': {
                'labels': {
                    ...
                    ACQUIRE_TIME_LABEL: datetime.datetime.utcnow()
                },
                'name': CM_NAME,
